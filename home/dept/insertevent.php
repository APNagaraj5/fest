...
/* connecting*/
$link = mysqli_connect("localhost", "root", "", "fest");
...
$onn = mysqli_connect("localhost","root@localhost","","fest");
...
$msg ="Dear $sname,
 ...
 Yoc can login to fest.pagekite.me/fest as cordinator to manage the ecent
 -------------------LOGIN ID = $cid
-------------------PASSWORD = co123"; 
...
$mail->addReplyTo('mr.technofreak420@gmail', "Ajay Chiller");
